...
\title{Mode and tempo of promoter evolution as measured in the Paramecium aurelia species complex}
...
\keyword{\textit{cis}-regulatory regions, \textit{Paramecium}, paralogs, promoter evolution, TSS profiling.}
